...
function transport_count = count_modes(file_path)
    ...
    modes = data(1:end, 1); % Extraire la première colonne qui contient les modes de transport
    quantities = cell2mat(data(1:end, 3)); % Extraire la troisième colonne qui contient les quantités et convertir en nombre
