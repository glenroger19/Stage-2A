...
function transport_count = count_modes(file_path)
    ...
    modes = data(1:end, 1); % Extraire la première colonne (après les en-têtes) qui contient les modes de transport
    quantities = cell2mat(data(1:end, 3)); % Extraire et convertir la troisième colonne en nombres
...
ylabel('Nombre de modes de transport');
